...
use cgmath::{Matrix4, PerspectiveFov, Rotation, Vector3};
...
impl Camera {
	...
	pub fn get_view_matrix(&self) -> Matrix4<f32> {
		Matrix4::look_at_dir(
			...
			self.transform.rotation.rotate_vector(Vector3::new(0.0, 0.0, 1.0)),
			self.transform.rotation.rotate_vector(Vector3::new(0.0, 1.0, 0.0)),
		)
	}
